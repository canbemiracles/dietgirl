...
<head>
	...
	<?php 
	   if ($_REQUEST['payer_status']=='verified'){
	     ...
	     <script type="text/javascript">
		    ga('create', 'UA-115418262-1', 'auto');
			ga('require', 'ecommerce');
			ga('ecommerce:addTransaction', {
                 'id': '<?php echo $_REQUEST['invoice']; ?>',                     // Transaction ID. Required.
                 'affiliation': 'Dietgirl',   // Affiliation or store name.
                 'revenue': '<?php echo $_REQUEST['mc_amount3']; ?>',               // Grand Total.

             });
			 
			 ga('ecommerce:addItem', {
                    'id': '<?php echo $_REQUEST['item_number']; ?>',                     // Transaction ID. Required.
                    'name': '<?php echo $_REQUEST['item_name']; ?>',    // Product name. Required.
                    'sku': '<?php echo $_REQUEST['item_number']; ?>',                 // SKU/code.
                    'price': '<?php echo $_REQUEST['mc_amount3']; ?>',                 // Unit price.
                    'quantity': '1'                   // Quantity.
             });
		    ga('ecommerce:send');
         </script>		
